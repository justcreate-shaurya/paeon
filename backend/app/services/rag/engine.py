...
class RAGIntelligenceEngine:
    ...
    async def get_intelligence_feed(
        ...
        all_items.extend(recalls)
        
        safety_alerts = await self.fetch_fda_safety_alerts(limit=10)
        all_items.extend(safety_alerts)
        
        # Add demo data for completeness
    ...
    def _get_demo_intelligence_items(self) -> list[dict[str, Any]]:
        ...
        return [
            ...
            },
            {
                ...
                "published_date": datetime(2026, 1, 27, tzinfo=timezone.utc),
                "is_verified": True,
            ...
            },
            {
                ...
                "published_date": datetime(2026, 1, 25, tzinfo=timezone.utc),
                "is_verified": True,
            ...
            },
            {
                ...
                "published_date": datetime(2026, 1, 24, tzinfo=timezone.utc),
                "is_verified": True,
